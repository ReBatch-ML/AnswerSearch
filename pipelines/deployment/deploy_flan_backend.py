"""Script to deploy the backend for the flan search on the GSC data."""
...
def create_deployment(ml_client, endpoint_name):
    ...
    deployment = ManagedOnlineDeployment(
        ...
        model=flan,
        environment=env,
        code_configuration=CodeConfiguration(code="src/deployment/backend", scoring_script="flan_score.py"),
