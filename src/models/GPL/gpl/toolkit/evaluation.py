...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default=' ',
        help=
        "Separation token between title and body text for each passage. The concatenation way is `sep.join([title, body])`"
    )
    parser.add_argument(
        '--k_values',
        nargs='+',
    ...
    parser.add_argument(
        '--split', type=str, default='test', choices=['train', 'test', 'dev'], help='Which split to evaluate on'
    )
